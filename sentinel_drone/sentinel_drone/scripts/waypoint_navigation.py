...
class Edrone():
	...
	def __init__(self):
		...
		self.setpoint = [0.0,0.0,0.0] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
	...
	#	8. Add error_sum
		...
		self.out_roll = int(1500 - ((self.Kp[0] * self.error[0]) + (self.Iterm[0]) + (self.Kd[0] * self.derivative[0])))
		self.out_pitch = int(1500 + ((self.Kp[1] * self.error[1]) + (self.Iterm[1]) + (self.Kd[1] * self.derivative[1])))
		self.out_throttle = int(1500 + ((self.Kp[2] * self.error[2]) + (self.Iterm[2]) + (self.Kd[2] * self.derivative[2])))
...
def main():
	...
	# z_z = 19.5
	# position_x = [8.5,8.5,8.5,0.0,0.0,0.0,-8.5,-8.5,-8.5]
	# position_y = [8.5,0.0,-8.5,-5.5,0.0,8.5,8.5,0.0,-8.5]
	# position_z = [z_z,z_z,z_z,z_z,z_z,z_z,z_z,z_z]
	# for i in range(0,7):
	...
	# e_drone.setpoint = [0.0,0.0,23.0]
	# while((e_drone.drone_position[0]> 0.0 + 0.15 or e_drone.drone_position[0]< 0.0 - 0.15) or(e_drone.drone_position[1]> 0.0 + 0.15 or e_drone.drone_position[1]< 0.0 - 0.15) or (e_drone.drone_position[2]>23.0 + 0.15 or e_drone.drone_position[2]< 23.0 - 0.15) ):
	# 	e_drone.pid()
	# 	r.sleep()
	
	# e_drone.setpoint = [2.0,0.0,23.0]
	# while((e_drone.drone_position[0]> 2.0 + 0.15 or e_drone.drone_position[0]< 2.0 - 0.15) or(e_drone.drone_position[1]> 0.0 + 0.15 or e_drone.drone_position[1]< 0.0 - 0.15) or (e_drone.drone_position[2]>23.0 + 0.15 or e_drone.drone_position[2]< 23.0 - 0.15) ):
	# 	e_drone.pid()
	# 	r.sleep()

	# e_drone.setpoint = [2.0,2.0,23.0]
	# while((e_drone.drone_position[0]> 2.0 + 0.15 or e_drone.drone_position[0]< 2.0 - 0.15) or(e_drone.drone_position[1]> 2.0 + 0.15 or e_drone.drone_position[1]< 2.0 - 0.15) or (e_drone.drone_position[2]>23.0 + 0.15 or e_drone.drone_position[2]< 23.0 - 0.15) ):
	# 	e_drone.pid()
	# 	r.sleep()
