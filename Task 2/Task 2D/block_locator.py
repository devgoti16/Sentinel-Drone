...
class object_detection():
    ...
    def image_callback(self, data):
        ...
        #trainIdx - The index or row of the kp2 interest point matrix that matches
                ...
                # Open tif file
                ds1 = gdal.Open('/home/dev-ubuntu/catkin_ws/src/sentinel_drone/sentinel_drone/scripts/map-with-gcps-change-reference.tif')
                # GDAL affine transform parameters, According to gdal documentation xoff/yoff are image left corner, a/e are pixel wight/height and b/d is rotation and is zero if image is north up. 
                ...
                geo_location.objectid = "object"+str(self.count)
                print(self.count)
            ...
            if len(self.contours) != 0 : #and self.flag == 0:
                #print(2)
                    #self.flag = 1
...
def main():
    ...
    position_x = [6.5,-6.5,-6.5]
    position_y = [-6.5,-6.5,6.5]
